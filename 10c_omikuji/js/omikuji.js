...
window.addEventListener("DOMContentLoaded",
    ...
    this.setTimeout(
        function(){
            let popMessage="Welcome to my Omikuji channel!";
...
btn1.addEventListener("click",
    function(){
        ...
        btn1.style.transition="1s";//??? delete it or not
        let resultText = [
            "img/daikichi.png",
            "img/chukichi.png",
            "img/syokichi.png",
       ...
       // let n=Math.floor(Math.random()*resultText.length)
        ...
        omikujiTextImage.src=resultText[n];//fukada-add
        ...
        soundContrl("start",w_sound);//sound
        soundEndflag="1";
...
let w_sound
let music
function soundContrl(status,w_sound){
    if(status==="start"){
