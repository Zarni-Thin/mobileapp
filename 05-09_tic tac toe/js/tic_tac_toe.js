...
// flag がpen-flagのときpinguins のターン、bear-flagのときbearのターン
let flag = "pen-flag";
let counter = 9;
...
const msgtxt1 =
  '<p class="image"><img src="img/penguin.png" width=61px height=61px></p><p class="text">Penguins Attack!(your turn)</p>';
const msgtxt2 =
  '<p class="image"><img src="img/bear.png" width=61px height=61px></p><p class="text">Whitebear Attack!(computer turn)</p>';
const msgtxt3 =
  '<p class="image"><img src="img/penguin.png" width=61px height=61px></p><p class="text animate__animated animate__fadeInLeft">Penguins Win!!</p>';
const msgtxt4 =
  '<p class="image"><img src="img/bear.png" width=61px height=61px></p><p class="text animate__animated animate__fadeInRight">WhiteBear Win!!</p>';
const msgtxt5 =
  '<p class="image"><img src="img/penguin.png" width=61px height=61px><img src="img/bear.png" width=61px height=61px></p><p class="text animate__animated animate__rotateIn">Draw!</p>';
  ...
  if (sessionStorage.getItem("tic_tac_toe_access")) {
    switch (index) {
      ...
      default:
        level_1.classList.add("level-selected");
        level_2.classList.add("level-non-selected");
        level_3.classList.add("level-mpm-selected");
        break;
    }
  } else {
    sessionStorage.setItem("tic_tac_toe_access", "1");
...
function isWinner(symbol) {
  const result = lineArray.some(function (line) {
    ...
    //insert return TRUE line into winningLine
    if (subResult) {
      winningLine = line;
    }
    return subResult;
...
function gameOver(status) {
  ...
  if (status === "penguins") {
    ...
    $(document).snowfall({
      flakeColor: "rgb(107, 214, 244)",
      maxSpeed: 3,
      minSpeed: 1,
      maxSize: 20,
      minSize: 10,
      round: true //  round type of snow
    });
  } else if (status === "bear") {
    //winnerline bear high-light
    if (winningLine) {
      winningLine.forEach(function (square) {
...
// clicking new game button to start the game
